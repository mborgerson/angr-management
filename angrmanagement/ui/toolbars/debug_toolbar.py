...
from PySide2.QtWidgets import QLabel, QComboBox, QAction
...
class DebugToolbar(Toolbar):
    ...
    def __init__(self, main_window: 'MainWindow'):
        ...
        self.workspace.instance.debugger.am_subscribe(self._on_debugger_selected)

        self._dbg_watcher = DebuggerWatcher(self._update_state, self.workspace)

    def _select_debugger_by_index(self, index: int):
        self.workspace.instance.set_debugger(self._debugger_combo.itemData(index))

    def _on_debugger_selected(self, *args, **kwargs):
    ...
    def _update_state(self):
        index = self._debugger_combo.currentIndex()
        self._update_debugger_list_combo()
        self._debugger_combo.setCurrentIndex(index)
