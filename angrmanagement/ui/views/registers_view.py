...
class QRegisterTableModel(QAbstractTableModel):
    ...
    def update_state(self, state):
        ...
        self.state = None if state is None else state.copy()
...
class QRegisterTableWidget(QTableView):
    ...
    def __init__(self, register_view, *args, **kwargs):
        ...
        dbg = self.register_view.workspace.instance.debugger
        dbg.am_subscribe(self._on_debugger_updated)
    ...
    def closeEvent(self, event):
        self.register_view.workspace.instance.debugger.am_unsubscribe(self._on_debugger_updated)
    ...
    def _on_debugger_state_updated(self):
        ...
        if dbg.am_none:
            self.model.update_state(None)
        else:
            self.model.update_state(dbg.simstate)
